...
horizon.event.websocket_message = function(a) {
  ...
  if(cljs.core.truth_(b.call(null, "cloud-event", c))) {
    var b = goog.dom.getElement.call(null, "events"), d = goog.dom.createDom.call(null, "li", null, goog.dom.htmlToDocumentFragment.call(null, a.value));
    goog.dom.classes.add.call(null, d, "new-event");
    horizon.ui.prependChild.call(null, b, d);
    window.p.call(null, d);
    horizon.ui.tabbar_flash.call(null, "Cloud events");
    new goog.fx.dom.FadeOutAndHide(d, 3E3);
    return window.setTimeout.call(null, function() {
      return goog.dom.classes.remove.call(null, d, "new-event")
    }, 1)
  }else {
